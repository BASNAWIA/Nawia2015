...
namespace BAS.Nawia.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController()
        {
            ...
            this.UserManager = new UserManager<UserModel>(new UserStore<UserModel>(new DAL.ApplicationDbContext()));
        }
        ...
        public async Task<ActionResult> Login(Common.Models.LoginViewModel model, string returnUrl)
        {
